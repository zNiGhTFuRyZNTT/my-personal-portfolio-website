        ...
        <div className="projects-inner-container">
            {ProjectsList.map((project, index) => {
                return <div key={index} className={`project-card p-6 max-w-sm ${inView ? `delay-${i++}` : 'delay-before'} bg-gray-100 rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700`}>
                    ...
                    <a href={project.projectUrl} className=" inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        View on Github
